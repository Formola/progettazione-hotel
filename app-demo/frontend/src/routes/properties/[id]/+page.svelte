<script lang="ts">
    ...
    // Gestione indici caroselli stanze
    ...
    <main class="section has-background-white-bis pb-6" style="min-height: 100vh;">
        <div class="container is-max-desktop">
            ...
            <div class="carousel-wrapper mb-6">
                <div class="carousel-container shadow-soft">
                    <img
                                                    ...
                                                    <div class="amenities-grid-compact">
                                                        {#each room.amenities as amenity}
                                                            ...
                                                            <div class="amenity-chip-compact {desc ? 'has-tooltip' : ''}">
                                                                <i class="fas {getAmenityIcon(amenity.name, amenity.category, 'room')}"></i>
...
<style>
    ...
    .carousel-container {
        ...
        border-radius: 16px;
        overflow: hidden;
        background: #f5f5f5; /* Placeholder grigio mentre carica */
        
        /* DIMENSIONI FISSE RESPONSIVE */
        width: 100%;
        height: 60vh;       /* 60% dell'altezza dello schermo */
        min-height: 400px;  /* Altezza minima per mobile */
        max-height: 650px;  /* Altezza massima per desktop giganti */
    ...
    .carousel-img {
        width: 100%;
        height: 100%;
        object-fit: cover; /* RIEMPIE IL CONTENITORE SENZA SPAZI VUOTI */
        display: block;
    }
    ...
    /* Mostra i pulsanti quando passi sopra il contenitore */
    ...
    .room-carousel-btn.prev { left: 15px; }
    .room-carousel-btn.next { right: 15px; }
    ...
    .host-card:hover, .info-card:hover {
        transform: translateY(-4px);
        box-shadow: 0 8px 30px rgba(0, 0, 0, 0.12);
    }
    ...
    /* Empty States */
    .empty-state, .empty-rooms {
        padding: 4rem 2rem;
        text-align: center;
    }

    .empty-state i, .empty-rooms i {
        font-size: 4rem;
        color: #cbd5e0;
        margin-bottom: 1rem;
    }
    ...
    @media (max-width: 768px) {
        .room-card-detail .columns, .room-header {
            flex-direction: column;
        }
        ...
        .carousel-container {
            height: 40vh; /* Meno alto su mobile */
        }
    }
</style>