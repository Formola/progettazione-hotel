										...
										{#if desc}
											<div class="tooltip-content">
												{#if amenity.custom_description}
													<span class="has-text-weight-bold has-text-warning-light is-block mb-1"
														>★ Details:</span
													>
												{/if}
												{desc}
								...
								<div class="box p-5 shadow-soft mb-4 room-card">
									<div class="columns">
										...
										<div class="column">
											...
											<button
												class="button is-primary is-fullwidth is-rounded has-text-weight-bold book-button mt-auto"
											>
												<span>Book Now</span>
